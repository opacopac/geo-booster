...
public class SqlRgKorridorTkIdsConverter implements SqlResultsetConverter<KeyValue<Long, Long>> {
    ...
    private final static String[] SELECT_COLS = {COL_ID_RELATIONSKORRIDOR_V, COL_ID_TARIFKANTE_E};


    @Override
    public String getSelectQuery() {
        return String.format(
            "SELECT %s FROM R_REL_KORR_X_TARIFKANTE_E",
