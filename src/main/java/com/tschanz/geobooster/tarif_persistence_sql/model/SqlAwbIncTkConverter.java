...
public class SqlAwbIncTkConverter implements SqlResultsetConverter<KeyValue<Long, Long>> {
    public final static String COL_ID_ANWBER_V = "ID_ANWBER_V";
    public final static String COL_ID_TARIF_KANTE_E = "ID_TARIF_KANTE_E";
    public final static String[] SELECT_COLS = {COL_ID_ANWBER_V, COL_ID_TARIF_KANTE_E};
